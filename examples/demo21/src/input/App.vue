<template>
  <div>
    ...
    <div class="cnt">
      slot 方式：
      <el-input placeholder="请选择日期" v-model="input2"><i slot="suffix" class="el-input__icon el-icon-date"></i></el-input>
      <el-input placeholder="请输入内容" v-model="input2"><i slot="prefix" class="el-input__icon el-icon-search"></i></el-input>
    </div>
    <!-- type="textarea" 不支持，因为不支持同步的 window.getComputedStyle -->
    <!-- <div class="cnt">
    ...
    <div class="cnt">
      <el-input placeholder="请输入内容" suffix-icon="el-icon-date" v-model="input5"></el-input>
      <el-input size="medium" placeholder="请输入内容" suffix-icon="el-icon-date" v-model="input5"></el-input>
      <el-input size="small" placeholder="请输入内容" suffix-icon="el-icon-date" v-model="input5"></el-input>
      <el-input size="mini" placeholder="请输入内容" suffix-icon="el-icon-date" v-model="input5"></el-input>
    </div>
    ...
    <div class="cnt">
      <el-autocomplete v-model="state4" :fetch-suggestions="querySearchAsync2" placeholder="请输入内容" @select="handleSelect"></el-autocomplete>
    </div>
    <div class="cnt">
      <el-input type="text" placeholder="请输入内容" v-model="text1" maxlength="10" show-word-limit></el-input>
    </div>
    <!-- <div class="cnt">
      <el-input type="textarea" placeholder="请输入内容" v-model="textarea3" maxlength="30" show-word-limit></el-input>
    </div> -->
  </div>
</template>
...
.cnt > .el-input, .cnt > .el-radio-group {
  margin-bottom: 10px;
  margin-left: 0;
  margin-right: 10px;
}
