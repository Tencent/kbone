...
module.exports = {
    properties: [{
        name: 'longitude',
        get(domNode) {
            const value = parseFloat(domNode.getAttribute('longitude'), 10)
            return !isNaN(value) ? value : 39.92
        },
    }, {
        name: 'latitude',
        get(domNode) {
            const value = parseFloat(domNode.getAttribute('latitude'), 10)
            return !isNaN(value) ? value : 116.46
        },
    }, {
        name: 'scale',
        get(domNode) {
            const value = parseFloat(domNode.getAttribute('scale'), 10)
        ...
        name: 'layerStyle',
        get(domNode) {
            const value = parseFloat(domNode.getAttribute('layer-style'), 10)
